...
class NewArchitectureHelper
    ...
    def self.install_modules_dependencies(spec, new_arch_enabled, folly_version = Helpers::Constants.get_folly_config()[:version])
        # Pod::Specification does not have getters so, we have to read
        # the existing values from a hash representation of the object.
        folly_config = Helpers::Constants.get_folly_config()
